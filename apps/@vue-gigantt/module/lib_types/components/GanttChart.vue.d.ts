import type { GanttBarObject, GanttChartProps } from 'types/index';
declare const _default: __VLS_WithTemplateSlots<import("vue").DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToOption<GanttChartProps>, {
    dateFormat: string;
    precision: string;
    width: string;
...
}, string, import("vue").PublicProps, Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToOption<GanttChartProps>, {
    dateFormat: string;
    precision: string;
    width: string;
    hideTimeaxis: boolean;
    ...
    width: string;
    hideTimeaxis: boolean;
    colorScheme: string | import("provider/themes").ColorScheme;
    grid: boolean;
    pushOnOverlap: boolean;
    noOverlap: boolean;
    rowHeight: number;
