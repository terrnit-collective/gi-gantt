...
export const isObject = <T>(obj: T): boolean => obj
&& typeof obj === 'object' && !Array.isArray(obj)

export const isDefined = <T>(d: T): boolean => d !== null && d !== undefined

export const blankIfUndefined = (value: string): string => typeof value !== 'undefined'
&& value !== null ? value : ''
...
export const toCssDimension = (width: string | number): string | number => !isDefined(width)
  ? null
...
export const isMobileAgent = {
  Android: (): boolean => typeof window !== 'undefined' &&
        !!window.navigator.userAgent.match(/Android/i),
  BlackBerry: (): boolean => typeof window !== 'undefined' &&
        !!window.navigator.userAgent.match(/BlackBerry/i),
  iOS: (): boolean => typeof window !== 'undefined' &&
        !!window.navigator.userAgent.match(/iPhone|iPad|iPod/i),
  Opera: (): boolean => typeof window !== 'undefined' &&
        !!window.navigator.userAgent.match(/Opera Mini/i),
  Windows: (): boolean => typeof window !== 'undefined' &&
        !!window.navigator.userAgent.match(/IEMobile/i),
  any: (): boolean => isMobileAgent.Android() ||
